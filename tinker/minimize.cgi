...
#
# ------------------------------------------------------------
# minimize.pl, by José R. Valverde (jrvalverde@es.embnet.org).
#
# Created: August 29, 2001
# Last updated: August 29, 2001
#
# MINIMIZE provides a simplified mechanism to run TINKER MINIMIZE
# over the web.
...
#
# $Id: minimize.cgi,v 1.3 2002/02/06 12:20:03 netadmin Exp $
# $Log: minimize.cgi,v $
...
$applongtitle= "Molecular Minimization";
$babel_dir=    "/opt/structure/babel";
$tinker=       "/opt/structure/tinker";
$minimize=     $tinker . "/bin/minimize";
...
sub runApp {
	...
	if ( $tinker_pid = fork) {
	    ...
	    print IN "$xyzfile\n$rms\n\n";
	    close IN;
	    print JOB "nice $minimize < minimize.in >> $logfile 2>&1\n";
	    ...
	    print IN "Subject: ### Your Tinker Minimize job $job\n";
	    print IN "\n";
	    close IN;
	    ...
	    if ($havewap) {
	    	open (IN, ">wap.msg");
	    	#print IN "Reply-To: $maintainer\n";
	    	#print IN "Subject: Minimize $job\n\n";
	    	print IN "\n\nYour job $job has finished.\n";
	    	close IN;
	    
	    	print JOB "$wapprog -s minimize $wapmail < wap.msg\n";
    	    }
	    print JOB "cd ..\n";
...
sub mailfile {
    local($file) = @_;
    open (MAIL, "|$mailprog $email") || die "MINIMIZE: Can\'t open $mailprog!\n";
    print MAIL "Reply-to: $email\n";
    print MAIL "Subject: TINKER MINIMIZE results\n\n";
