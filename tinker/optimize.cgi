...
#
# ------------------------------------------------------------
# optmize.pl, by José R. Valverde (jrvalverde@es.embnet.org).
#
# Created: September 4, 2001
# Last updated: September 4, 2001
#
# OPTIMIZE provides a simplified mechanism to run TINKER OPTIMIZE
# over the web.
...
#
# $Id: optimize.cgi,v 1.3 2002/02/06 12:20:03 netadmin Exp $
# $Log: optimize.cgi,v $
...
sub runApp {
	...
	if ( $tinker_pid = fork) {
	    ...
	    print IN "$xyzfile\n$rms\n";
	    close IN;
	    print JOB "nice $optimize < optimize.in >> $logfile 2>&1\n";
	    ...
	    print IN "Subject: ### Your Tinker optimize job $job\n";
	    print IN "\n";
	    close IN;
	    ...
	    if ($havewap) {
	    	open (IN, ">wap.msg");
	    	#print IN "Reply-To: $maintainer";
	    	#print IN "Subject: optimize $job\n\n";
	    	print IN "\n\nYour job $job has finished.\n";
	    	close IN;
	    
	    	print JOB "$wapprog -s optimize $wapmail < wap.msg\n";
    	    }
	    print JOB "cd ..\n";
	    ...
	    print  "<CENTER><BR><STRONG>Running: BABEL + PDBXYZ + MINIMIZE + XYZPDB </STRONG><BR></CENTER>\n";
	    print <<ENDDONE1;
	    &nbsp;<BR>
...
sub mailfile {
    local($file) = @_;
    open (MAIL, "|$mailprog $email") || die "OPTIMIZE: Can\'t open $mailprog!\n";
    print MAIL "Reply-to: $email";
    print MAIL "Subject: TINKER Optimization results\n\n";
