...
//
// $Id: pdb2vrml2_client.php,v 1.2 2005/10/07 13:26:56 netadmin Exp $
// $Log: pdb2vrml2_client.php,v $
// Revision 1.2  2005/10/07 13:26:56  netadmin
...
$server_url = 'http://eris.cnb.uam.es/cgi-src/pdb_servlets/pdb2vrml2-ws.php?wsdl';
...
////////////////////////////////// START /////////////////////////////////
    ...
    if (isset($dnld)) {
	header("Content-type: text/plain");
	header("Content-Disposition: inline; filename=pdb2vrml2.txt");
    ...
    if ($debug == 0) 
    	...
    	header("Content-type: text/plain");
    header("Content-Disposition: inline; filename=structure.wrl");
    print $vrml_world;    
...
function generate_world($server_url, $url)
{
    ...
    // Call the SOAP method
    $result = $proxy->VRML2_virtual_world_URL($url);
