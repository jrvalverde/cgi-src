...
echo "<CENTER><H1>Thank you for using HTH</H1></CENTER>"
...
$ReadSeq -f=13 $inseqfile > $plainseqfile
...
$HTH > $outputfile 2>&1 << END
$plainseqfile
q
END
cat $outputfile | sed -e 's/Name of protein file (q\/Q = Quit): //g' |\
sed -e 's/Good-bye!//g'
...
echo 'Administrator</A> <A HREF="http://www.es.embnet.org/Copyright-CSIC.html">&copy; EMBnet/CNB</A>'
echo "</BODY>"
echo "</HTML>"
