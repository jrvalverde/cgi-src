#!/bin/sh
#
# (C) 2000, José R. Valverde, EMBnet/CNB
...
webdir=tmp/pdb2vr.${RANDOM}.${RANDOM}
...
tmppdbfile=$workdir/tmppdb.${RANDOM}.${RANDOM}
weboutput=tmp/output.${RANDOM}.${RANDOM}.wrl
outputfile=/data/www/EMBnet/$weboutput
