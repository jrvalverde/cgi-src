...
$recipientname = 'Jos&eacute; R. Valverde';
...
print "<Body BACKGROUND=\"/~txomsy/images/backgrounds/marble2back.gif\">\n";
...
print "<hr>";
print "<Form method=POST action=\"http:/cgi-bin/jose-mail.pl\">\n";
...
print "<INPUT TYPE=\"hidden\" NAME=\"recipientname\" VALUE=\"$FORM{'recipientname'}\">\n";
