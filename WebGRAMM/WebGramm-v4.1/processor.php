...
// With a browser we see a different directories hierarchy
$http_tmproot="/tmp";
...
//
function set_tmp_dir( $random_str, $system_tmproot, $http_tmproot )
{   	
	mkdir ("$system_tmproot/webgramm$random_str", 0775); 
	...
	copy("./6h2o-w-small.gif", "$system_tmproot/webgramm$random_str/6h2o-w-small.gif");
	copy("./left.gif", "$system_tmproot/webgramm$random_str/left.gif");
	copy("./right.gif", "$system_tmproot/webgramm$random_str/right.gif");
	copy("./show_results.php", "$system_tmproot/webgramm$random_str/index.php");
	copy("./gramm_control", "$system_tmproot/webgramm$random_str/gramm_control");
	chdir( "$system_tmproot/webgramm$random_str" ); 
	chmod ("./gramm.sh", 0755);


	echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"5; URL=$http_tmproot/webgramm$random_str\">";
}
